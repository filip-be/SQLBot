...
namespace MaterialSkin.Controls
{
    public class MaterialForm : Form, IMaterialControl
    {
        ...
        public bool DrawBorderLine { get; set; }
        public bool DrawStatusBar { get; set; }
        public bool DrawActionBar { get; set; }
        public bool Moveable { get; set; }
        public bool Sizable { get; set; }

        public Image TitleImage { get; set; }
        public int TitleImageWidth { get; set; }
        public LocationType TitleImageLocation { get; set; }
        public LocationType TitleLocation { get; set; }
        ...
        public int STATUS_BAR_BUTTON_WIDTH { get; set; }
        public int STATUS_BAR_BUTTON_HEIGHT { get; set; }
        private int _STATUS_BAR_HEIGHT;
        private int _ACTION_BAR_HEIGHT;
        ...
        { 
            get
            {
                return _ACTION_BAR_HEIGHT;
            }
            set
            {
                _ACTION_BAR_HEIGHT = value;
                if (DrawActionBar)
                {
                    actionBarBounds = new Rectangle(0, DrawStatusBar ? STATUS_BAR_HEIGHT : 0, Width, ACTION_BAR_HEIGHT);
                }
            }
        }
        ...
        public MaterialForm()
        {
            ...
            TitleLocation = LocationType.ActionBar;
            TitleImageLocation = LocationType.None;
            TitleImage = null;
            TitleImageWidth = 0;
            STATUS_BAR_HEIGHT = 24;
            ACTION_BAR_HEIGHT = 40;
            STATUS_BAR_BUTTON_WIDTH = 24;
            STATUS_BAR_BUTTON_HEIGHT = 24;
            Sizable = true;
            DrawBorderLine = true;
            DrawStatusBar = true;
            DrawActionBar = true;
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && !Maximized && Moveable)
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            minButtonBounds = new Rectangle((Width - SkinManager.FORM_PADDING / 2) - 3 * STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_BUTTON_HEIGHT);
            maxButtonBounds = new Rectangle((Width - SkinManager.FORM_PADDING / 2) - 2 * STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_BUTTON_HEIGHT);
            xButtonBounds = new Rectangle((Width - SkinManager.FORM_PADDING / 2) - STATUS_BAR_BUTTON_WIDTH, 0, STATUS_BAR_BUTTON_WIDTH, STATUS_BAR_BUTTON_HEIGHT);
            if (DrawStatusBar)
            {
                statusBarBounds = new Rectangle(0, 0, Width, STATUS_BAR_HEIGHT);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (DrawStatusBar)
            {
                ...
                if(TitleImageLocation == LocationType.StatusBar)
                    g.DrawImage(TitleImage, new Rectangle(BORDER_WIDTH, 2, STATUS_BAR_HEIGHT - 4, STATUS_BAR_HEIGHT - 4));
                if(TitleLocation == LocationType.StatusBar)
                    g.DrawString(Text,
                        SkinManager.ROBOTO_MEDIUM_12, 
                        SkinManager.ColorScheme.TextBrush, 
                        new Rectangle(BORDER_WIDTH + (TitleImageLocation == LocationType.StatusBar ? STATUS_BAR_HEIGHT : 0), 0, Width, STATUS_BAR_HEIGHT), 
            ...
            {
                int TitleX = 0;
                if(TitleImageLocation == LocationType.ActionBar && TitleImage != null)
                {
                    TitleX = TitleImageWidth + 5;
                    g.DrawImage(TitleImage, new Rectangle(SkinManager.FORM_PADDING, DrawStatusBar ? STATUS_BAR_HEIGHT : 0, TitleImageWidth, ACTION_BAR_HEIGHT));
                }

                if(TitleLocation == LocationType.ActionBar)
                    g.DrawString(Text, 
                        SkinManager.ROBOTO_MEDIUM_12, 
                        SkinManager.ColorScheme.TextBrush, 
                        new Rectangle(SkinManager.FORM_PADDING + TitleX, DrawStatusBar ? STATUS_BAR_HEIGHT : 0, Width, ACTION_BAR_HEIGHT), 
                        new StringFormat { LineAlignment = StringAlignment.Center });
            }
        }
    }
